...
function createMenuItem(objName, objPrice, objCategory) {
  const passedObj = {};
  passedObj.name = objName;
  passedObj.price = objPrice;
  passedObj.category = objCategory;
  return passedObj;
}

// console.log(createMenuItem("Fries", 7, "Appetizers"));
...
console.log(createMenuItem("Apple", 1, "Dessert"));
console.log(createMenuItem("Pie", 2, "Dessert"));
console.log(createMenuItem("Calamari", 5, "Appetizers"));
...
export const burger = {
  ...
  price: 18,
  category: "Lunch",
  discount(dinerStatus) {
    if (dinerStatus === "teacher") {
      return this.price * 0.75;
    } else if (dinerStatus === "student") {
      return this.price * 0.75;
    } else if (dinerStatus === "public") {
...
function addReviewObject(name, rating, feedback) {
  const passedObj = {};
  passedObj.name = name;
  passedObj.rating = rating;
  passedObj.feedback = feedback;
  return passedObj;
}

reviews.push(addReviewObject("David", 4, "TRASH"));
